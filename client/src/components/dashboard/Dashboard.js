  ...
  const claimTicket = e => {
      ...
      axiosWithAuth().put(`url/tickets/${e.target.id}`, editTicket)
        .then(res => {
          ...
          axiosWithAuth().put('url', {...state.user, staffTickets: [state.user.staffTickets, editTicket.id]})
            .then (res => {
              console.log(res)
            })
            .catch(err => {
    ...
    const filteredTickets = tickets.filter(item => {
      ...
      .then(res => {
        ...
        .then(res => {
           ...
           const newStaffTickets = [state.user.staffTickets.filter(item => {
             return item.id !== e.target.id
           })]
          axiosWithAuth().put('url', {...state.user, staffTickets: newStaffTickets })
            .then (res => {
              console.log(res)
            })
            .catch(err => {
